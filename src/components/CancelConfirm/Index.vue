<template>
  ...
  >
    ...
    <div class="confirm-cancel__actions">
      <div class="confirm-cancel__actions__action confirm-cancel__actions__action--no">
        <VButton
      ...
      <div class="confirm-cancel__actions__action confirm-cancel__actions__action--yes">
        <VButton
